...
LDDLFLAGS = -L/opt/local/lib -arch x86_64 -arch i386 -bundle -undefined dynamic_lookup -L/usr/local/lib
LDFLAGS = -L/opt/local/lib -arch x86_64 -arch i386 -L/usr/local/lib
...
CCFLAGS = -O2 -arch x86_64 -arch i386 -fno-common -DPERL_DARWIN -I/opt/local/include -no-cpp-precomp -fno-strict-aliasing -pipe -I/usr/local/include -I/opt/local/include
OPTIMIZE = -O3
PERLTYPE = 
MPOLLUTE = 
