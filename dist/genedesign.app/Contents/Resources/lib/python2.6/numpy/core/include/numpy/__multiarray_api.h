...
#define PyGenericArrType_Type (*(PyTypeObject *)PyArray_API[9])
#define PyNumberArrType_Type (*(PyTypeObject *)PyArray_API[10])
#define PyIntegerArrType_Type (*(PyTypeObject *)PyArray_API[11])
#define PySignedIntegerArrType_Type (*(PyTypeObject *)PyArray_API[12])
#define PyUnsignedIntegerArrType_Type (*(PyTypeObject *)PyArray_API[13])
#define PyInexactArrType_Type (*(PyTypeObject *)PyArray_API[14])
#define PyFloatingArrType_Type (*(PyTypeObject *)PyArray_API[15])
#define PyComplexFloatingArrType_Type (*(PyTypeObject *)PyArray_API[16])
#define PyFlexibleArrType_Type (*(PyTypeObject *)PyArray_API[17])
#define PyCharacterArrType_Type (*(PyTypeObject *)PyArray_API[18])
#define PyByteArrType_Type (*(PyTypeObject *)PyArray_API[19])
#define PyShortArrType_Type (*(PyTypeObject *)PyArray_API[20])
#define PyIntArrType_Type (*(PyTypeObject *)PyArray_API[21])
#define PyLongArrType_Type (*(PyTypeObject *)PyArray_API[22])
#define PyLongLongArrType_Type (*(PyTypeObject *)PyArray_API[23])
#define PyUByteArrType_Type (*(PyTypeObject *)PyArray_API[24])
#define PyUShortArrType_Type (*(PyTypeObject *)PyArray_API[25])
#define PyUIntArrType_Type (*(PyTypeObject *)PyArray_API[26])
#define PyULongArrType_Type (*(PyTypeObject *)PyArray_API[27])
#define PyULongLongArrType_Type (*(PyTypeObject *)PyArray_API[28])
#define PyFloatArrType_Type (*(PyTypeObject *)PyArray_API[29])
#define PyDoubleArrType_Type (*(PyTypeObject *)PyArray_API[30])
#define PyLongDoubleArrType_Type (*(PyTypeObject *)PyArray_API[31])
#define PyCFloatArrType_Type (*(PyTypeObject *)PyArray_API[32])
#define PyCDoubleArrType_Type (*(PyTypeObject *)PyArray_API[33])
#define PyCLongDoubleArrType_Type (*(PyTypeObject *)PyArray_API[34])
#define PyObjectArrType_Type (*(PyTypeObject *)PyArray_API[35])
#define PyStringArrType_Type (*(PyTypeObject *)PyArray_API[36])
#define PyUnicodeArrType_Type (*(PyTypeObject *)PyArray_API[37])
#define PyVoidArrType_Type (*(PyTypeObject *)PyArray_API[38])
#define PyTimeIntegerArrType_Type (*(PyTypeObject *)PyArray_API[39])
#define PyDatetimeArrType_Type (*(PyTypeObject *)PyArray_API[40])
#define PyTimedeltaArrType_Type (*(PyTypeObject *)PyArray_API[41])
