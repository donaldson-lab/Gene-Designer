...
--------------------------------------------------------------------------- */
/* compiled by the ADP compiler, version 0.8 (rev 690)    Tue Sep 12 13:30:36 MEST 2006 */
/* source file: pknotsRG-mfe-nd.lhs                                                 */
/* command:                                                                         */
/* adpcompile -c pknotsRG-mfe-nd.lhs -al energy enum -cs energy -alpp pp -O -lcf -ta bto -bt so -gc cc -iuc -W */
/* -------------------------------------------------------------------------------- */
...
static struct str3 *back_closed(int i, int j, int diff)
{
   struct str3 *v44;
   int v10, v19, v25, v40;
   struct str5 *v1, *v2, *v3, *v4, *v5, *v6;
   struct str5 *v7, *v8, *v9, *v11, *v12, *v13, *v14;
   struct str5 *v15, *v16, *v17, *v18, *v20, *v21;
   struct str5 *v22, *v23, *v24, *v26, *v27, *v28, *v29;
   struct str5 *v30, *v31, *v32, *v33, *v34, *v35;
   struct str5 *v36, *v37, *v38, *v39, *v41, *v42, *v43;
   int k, k2, k3, k4, k5;
   ...
   v42 = NULL;
   while (v39 != NULL) {
      if (abs(v40 - v39->item.alg_energy) <= diff) {
   ...
   v44 = NULL;
   while (v43 != NULL) {
      /* -------------------- v44 = v43->item.alg_enum ++ v44 --------------------- */
      if (v43->item.alg_enum == NULL) {
      } else 
      if (v44 == NULL) {
         v44 = v43->item.alg_enum;
      }
      else {
         v43->item.alg_enum->last->next = v44;
         v43->item.alg_enum->last = v44->last;
         v44 = v43->item.alg_enum;
      }
      v43 = v43->next;
   }
   memory_clear(adp_dynmem);
   return(build_str_Signature(copy_str_Signature(v44)));
}
...
static struct str3 *back_knot(int i, int j, int diff)
{
   ...
   struct str1 v49;
   int v9, v22, v30, v40;
   struct str5 *v2, *v3, *v4, *v5, *v6, *v7, *v8, *v10, *v11, *v12;
   struct str5 *v13, *v14, *v15, *v16, *v17, *v18, *v19, *v20, *v21, *v23;
   struct str5 *v24, *v25, *v26, *v27, *v28, *v29, *v31, *v32, *v33, *v34;
   struct str5 *v35, *v36, *v37, *v38, *v39, *v41, *v42, *v44, *v45, *v46;
   struct str7 *v1, *v43, *v47, *v48, *v50, *v51, *v52;
   int lc_alphanrg, lc_betalen, lc_betanrg, lc_correctionterm, lc_energy;
   int lc_h, lc_h_Pr, lc_k, lc_l, lc_middle_k, lc_middle_l;
   ...
   while (v48 != NULL) {
      if (abs(v49.tup1 - v48->item.alg_energy.tup1) <= diff) {
         ...
         v50=(struct str7 *) myalloc(adp_dynmem, sizeof(struct str7 ));
         v50->item = v48->item;
         v50->next = NULL;
         v50->last = v50;
         /* --------------------------- v51 = v50 ++ v51 -------------------------- */
...
int main_pk_mfe_so_nd(toptions *_opts, tsequence *_seq)
{
   ...
   if (opts->debug) printf("pk-mfe-so-nd.c\n");
