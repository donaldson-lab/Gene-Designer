...
--------------------------------------------------------------------------- */
/* compiled by the ADP compiler, version 0.8 (rev 690)    Tue Sep 12 13:29:04 MEST 2006 */
/* source file: pknotsRG-mfe.lhs                                                    */
/* command:                                                                         */
/* adpcompile -c pknotsRG-mfe.lhs -al energy enum -cs energy -alpp pp -O -lcf -ta bto -bt so -gc cc -iuc -W */
/* -------------------------------------------------------------------------------- */
...
static struct str3 *back_closed(int i, int j, int diff)
{
   ...
   struct str5 *v53, *v54, *v55, *v56, *v57, *v58;
   struct str5 *v59, *v60, *v61, *v63, *v64, *v65;
   int k, k2, k3, k4, k5, k6, k7, k8;
   ...
   if (stackpairing(i, j)) {
      ...
      v51 = v50;
      while (v51 != NULL) {
         v52 = v52 < v51->item.alg_energy ? v52 : v51->item.alg_energy;
         v51 = v51->next;
      }
      v51 = v50;
      v54 = NULL;
      while (v51 != NULL) {
         if (abs(v52 - v51->item.alg_energy) <= diff) {
            update_str_Signature(v51->item.alg_enum->item, diff - abs(v52 - v51->item.alg_energy));
            v53=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
            v53->item = v51->item;
            v53->next = NULL;
            v53->last = v53;
            /* ------------------------- v54 = v53 ++ v54 ------------------------- */
   ...
   v61 = v60;
   while (v61 != NULL) {
      v62 = v62 < v61->item.alg_energy ? v62 : v61->item.alg_energy;
      v61 = v61->next;
   }
   v61 = v60;
   v64 = NULL;
   while (v61 != NULL) {
      if (abs(v62 - v61->item.alg_energy) <= diff) {
         update_str_Signature(v61->item.alg_enum->item, diff - abs(v62 - v61->item.alg_energy));
   ...
   v66 = NULL;
   while (v65 != NULL) {
      /* -------------------- v66 = v65->item.alg_enum ++ v66 --------------------- */
      if (v65->item.alg_enum == NULL) {
      } else 
      if (v66 == NULL) {
         v66 = v65->item.alg_enum;
      }
      else {
         v65->item.alg_enum->last->next = v66;
         v65->item.alg_enum->last = v66->last;
         v66 = v65->item.alg_enum;
      }
      v65 = v65->next;
   }
   memory_clear(adp_dynmem);
   return(build_str_Signature(copy_str_Signature(v66)));
}
...
static struct str3 *back_knot(int i, int j, int diff)
{
   ...
   struct str5 *v2, *v3, *v4, *v5, *v6, *v7, *v8, *v9, *v11, *v12, *v13;
   struct str5 *v14, *v15, *v16, *v17, *v18, *v19;
   struct str5 *v20, *v21, *v22, *v24, *v25, *v26;
   struct str5 *v27, *v28, *v29, *v31, *v32, *v33;
   struct str5 *v34, *v35, *v36, *v37, *v38, *v39;
   struct str5 *v40, *v41, *v42, *v43, *v45, *v46;
   struct str5 *v47, *v48, *v49, *v50, *v51, *v52;
   struct str5 *v53, *v54, *v55, *v56, *v58, *v59;
   struct str5 *v60, *v61, *v62, *v63, *v64, *v65;
   struct str5 *v66, *v67, *v68, *v69, *v71, *v72;
   struct str5 *v73, *v74, *v75, *v76, *v77, *v78;
   struct str5 *v79, *v80, *v81, *v82, *v84, *v85;
   struct str5 *v86, *v87, *v88, *v89, *v90, *v91;
   struct str5 *v92, *v93, *v94, *v96, *v97, *v98;
   struct str5 *v99, *v100, *v101, *v102, *v103, *v104;
   struct str5 *v105, *v107, *v108, *v109, *v110, *v111;
   struct str5 *v112, *v113, *v114, *v115, *v116, *v117;
   struct str5 *v118, *v120, *v121, *v122, *v123, *v124;
   struct str5 *v125, *v127, *v128, *v130, *v131, *v132;
   struct str7 *v1, *v129, *v133, *v134, *v136, *v137, *v138;
   int lc_alphanrg, lc_betalen, lc_betanrg, lc_correctionterm, lc_energy;
   int lc_h, lc_h_Pr, lc_k, lc_l, lc_middle_k, lc_middle_l;
         ...
         for (lc_k=lc_l+1; lc_k<=j-2; lc_k++) {
            ...
            if (lc_h >= 2) {
               ...
               if (lc_h_Pr >= 2) {
                  ...
                  lc_energy = ((lc_alphanrg + lc_betanrg) - lc_correctionterm) + (pbp * (lc_h + lc_h_Pr));
                  /* -------------------------- start of -------------------------- */
                  /* --- v13 = co <<< pul <<< pss <<< uregion ||| p comps ... h --- */
                  if ((lc_l-(i+lc_h)-1) >= 0) {
                     /* ------------------------- start of ------------------------ */
                     /* --------------- v5 = pul <<< pss <<< uregion -------------- */
                     /* ------------------------- start of ------------------------ */
                  ...
                  if ((lc_l-(i+lc_h)-1) >= 1) {
                     ...
                     v25 = NULL;
                     while (v22 != NULL) {
                        if (abs(v23 - v22->item.alg_energy) <= diff) {
                           update_str_Signature(v22->item.alg_enum->item, diff - abs(v23 - v22->item.alg_energy));
                           v24=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                           v24->item = v22->item;
                           v24->next = NULL;
                           v24->last = v24;
                           /* ------------------ v25 = v24 ++ v25 ----------------- */
                  ...
                  v32 = NULL;
                  while (v29 != NULL) {
                     if (abs(v30 - v29->item.alg_energy) <= diff) {
                        update_str_Signature(v29->item.alg_enum->item, diff - abs(v30 - v29->item.alg_energy));
                        v31=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                        v31->item = v29->item;
                        v31->next = NULL;
                        v31->last = v31;
                        /* ------------------- v32 = v31 ++ v32 ------------------- */
                  ...
                  /* -------------------------- start of -------------------------- */
                  /*  v47 = middl lc_middle_k <<< lbase ~~~ (pul <<< pss <<< region ||| p comps ... h)  */
                  if ((lc_k-lc_h-(lc_l+lc_h_Pr)) >= 2) {
                     /* ------------------------- start of ------------------------ */
                     /* --------------- v39 = pul <<< pss <<< region -------------- */
                     /* ------------------------- start of ------------------------ */
                     ...
                     v46 = NULL;
                     while (v43 != NULL) {
                        if (abs(v44 - v43->item.alg_energy) <= diff) {
                  ...
                  /* -------------------------- start of -------------------------- */
                  /*  v60 = middr lc_middle_l <<< (pul <<< pss <<< region ||| p comps ... h) ~~~ lbase  */
                  if ((lc_k-lc_h-(lc_l+lc_h_Pr)) >= 2) {
                     /* ------------------------- start of ------------------------ */
                     /* --------------- v52 = pul <<< pss <<< region -------------- */
                     /* ------------------------- start of ------------------------ */
                     ...
                     v59 = NULL;
                     while (v56 != NULL) {
                        if (abs(v57 - v56->item.alg_energy) <= diff) {
                           update_str_Signature(v56->item.alg_enum->item, diff - abs(v57 - v56->item.alg_energy));
                           v58=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                           v58->item = v56->item;
                           v58->next = NULL;
                           v58->last = v58;
                           /* ------------------ v59 = v58 ++ v59 ----------------- */
                  ...
                  /* -------------------------- start of -------------------------- */
                  /*  v73 = middlr lc_middle_k lc_middle_l <<< lbase ~~~ (pul <<< pss <<< region ||| p comps ... h) ~~~ lbase  */
                  if ((lc_k-lc_h-(lc_l+lc_h_Pr)) >= 3) {
                     /* ------------------------- start of ------------------------ */
                     /* --------------- v65 = pul <<< pss <<< region -------------- */
                     /* ------------------------- start of ------------------------ */
                     ...
                     /* +---------------------------------------------------------------------------- */
                     if ((lc_k-lc_h-(lc_l+lc_h_Pr)-2) >= 7) {
                        v67=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                     ...
                     v72 = NULL;
                     while (v69 != NULL) {
                        if (abs(v70 - v69->item.alg_energy) <= diff) {
                     ...
                     v74 = v72;
                     while (v74 != NULL) {
                        v62=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                        v62->next = NULL;
                        v62->last = v62;
                  ...
                  /* -------------------------- start of -------------------------- */
                  /*  v86 = midregion <<< pul <<< pss <<< region ||| p comps ... h  */
                  if ((lc_k-lc_h-(lc_l+lc_h_Pr)) >= 1) {
                     /* ------------------------- start of ------------------------ */
                     /* --------------- v78 = pul <<< pss <<< region -------------- */
                     /* ------------------------- start of ------------------------ */
                     ...
                     /* +---------------------------------------------------------------------------- */
                     if ((lc_k-lc_h-(lc_l+lc_h_Pr)) >= 7) {
                        v80=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                     ...
                     v85 = NULL;
                     while (v82 != NULL) {
                        if (abs(v83 - v82->item.alg_energy) <= diff) {
                           update_str_Signature(v82->item.alg_enum->item, diff - abs(v83 - v82->item.alg_energy));
                           v84=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                           v84->item = v82->item;
                           v84->next = NULL;
                           v84->last = v84;
                           /* ------------------ v85 = v84 ++ v85 ----------------- */
                  ...
                  /* -------------------------- start of -------------------------- */
                  /* -- v109 = co <<< pul <<< pss <<< uregion ||| p comps ... h --- */
                  if ((j-lc_h_Pr-lc_k-2) >= 0) {
                     /* ------------------------- start of ------------------------ */
                     /* -------------- v101 = pul <<< pss <<< uregion ------------- */
                     /* ------------------------- start of ------------------------ */
                     /* ------------------ v100 = pss <<< uregion ----------------- */
                     v100=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                     v100->next = NULL;
                     v100->last = v100;
                     ...
                     v102 = v100;
                     while (v102 != NULL) {
                        v99=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                        v99->next = NULL;
                        v99->last = v99;
                     ...
                     /* +---------------------------------------------------------------------------- */
                     if ((j-lc_h_Pr-lc_k-2) >= 7) {
                        v103=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                     ...
                     v108 = NULL;
                     while (v105 != NULL) {
                        if (abs(v106 - v105->item.alg_energy) <= diff) {
                           update_str_Signature(v105->item.alg_enum->item, diff - abs(v106 - v105->item.alg_energy));
                           v107=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                           v107->item = v105->item;
                           v107->next = NULL;
                           v107->last = v107;
                           /* ---------------- v108 = v107 ++ v108 ---------------- */
                     ...
                     v110 = v108;
                     while (v110 != NULL) {
                        v98=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                        v98->next = NULL;
                        v98->last = v98;
                  ...
                  if ((j-lc_h_Pr-lc_k-2) >= 1) {
                     ...
                     /* ------------------------- start of ------------------------ */
                     /* ------------------ v113 = pss <<< uregion ----------------- */
                     v113=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                     v113->next = NULL;
                     v113->last = v113;
                     ...
                     v121 = NULL;
                     while (v118 != NULL) {
                        if (abs(v119 - v118->item.alg_energy) <= diff) {
                           update_str_Signature(v118->item.alg_enum->item, diff - abs(v119 - v118->item.alg_energy));
                           v120=(struct str5 *) myalloc(adp_dynmem, sizeof(struct str5 ));
                           v120->item = v118->item;
                           v120->next = NULL;
                           v120->last = v120;
                           /* ---------------- v121 = v120 ++ v121 ---------------- */
                  ...
                  v128 = NULL;
                  while (v125 != NULL) {
                     if (abs(v126 - v125->item.alg_energy) <= diff) {
                  ...
                  /*      co <<< pul <<< pss <<< uregion ||| p comps ... h ||| frd j <<< (pul <<< pss <<< uregion ||| p comps ... h) ~~~ lbase ... h           */
                  /*                                                                                                                                           */
                  ...
                  while (v132 != NULL) {
                     ...
                     /*      emptymid lc_middle_k lc_middle_l <<< empty ||| midbase lc_middle_k lc_middle_l <<< lbase ||| middlro lc_middle_k lc_middle_l <<< lbase ~~~ lbase ||| middl lc_middle_k <<< lbase ~~~ (pul <<< pss <<< region ||| p comps ... h) ||| middr lc_middle_l <<< (pul <<< pss <<< region ||| p comps ... h) ~~~ lbase ||| middlr lc_middle_k lc_middle_l <<< lbase ~~~ (pul <<< pss <<< region ||| p comps ... h) ~~~ lbase ||| midregion <<< pul <<< pss <<< region ||| p comps ... h ... h           */
                     /*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      */
                     ...
                     while (v131 != NULL) {
                        ...
                        /*      co <<< pul <<< pss <<< uregion ||| p comps ... h ||| bkd i <<< lbase ~~~ (pul <<< pss <<< uregion ||| p comps ... h) ... h           */
                        /*                                                                                                                                           */
   ...
   while (v134 != NULL) {
      if (abs(v135.tup1 - v134->item.alg_energy.tup1) <= diff) {
         ...
         v136=(struct str7 *) myalloc(adp_dynmem, sizeof(struct str7 ));
         v136->item = v134->item;
         v136->next = NULL;
         v136->last = v136;
         /* ------------------------- v137 = v136 ++ v137 ------------------------- */
...
int main_pk_mfe_so(toptions *_opts, tsequence *_seq)
{
   ...
   if (opts->debug) printf("pk-mfe-so.c\n");
