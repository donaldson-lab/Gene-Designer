...
int   wkn                   ;   /* The weighting parameter for pseudoknots */
int   npp                   ;   /* Unpaired base in a pseudoknot */
int   pbp                   ;   /* Basepair in a pseudoknot */
int   pkinit                ;   /* pseudoknot - init - penalty */
int   max_pknot_length      ;   /* maximal pseudoknot-length (-1 -> maximal) */
int   max_pknot_length_user ;   /* maximal pseudoknot-length (-1 -> maximal) */
...
#define open1(i,j) libPP_repeat(i,j,'[')
#define close1(i,j) libPP_repeat(i,j,']')
#define open2(i,j) libPP_repeat(i,j,'{')
#define close2(i,j) libPP_repeat(i,j,'}')
